...
import { OptimizationHistoryItem } from '@/lib/api/history';
import { formatDate, formatDateTime } from '@/lib/utils/dateFormat';

interface Props {
  data: OptimizationHistoryItem[];
                ...
                <td className="px-3 py-3 whitespace-nowrap text-sm text-center">
                  <div className="flex items-center justify-center gap-1">
                    <button
                      ...
                      className="p-1.5 text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 hover:bg-primary-50 dark:hover:bg-primary-900/30 rounded transition-colors"
                      title="View results"
                    >
