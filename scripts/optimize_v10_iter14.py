#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""V10 Iteration 14: Balance quality and quantity"""
import requests
import time

API_URL = "http://localhost:8000/api/v1/backtest/run"

# Try to balance all metrics
payload = {
    ...
    "parameters": {
        ...
        "fast_ema1": 14,               # Slightly faster
        "slow_ema1": 40,               # Slightly faster
        "fast_ema2": 20,               # Slightly faster
        "slow_ema2": 50,               # Slightly faster
        "rsi_long_entry_strict": 30,   # Back to V8 levels
...
print("=" * 70)
print("V10 ITERATION #14: Balance quality and quantity")
print("=" * 70)
print("Approach: Slightly faster EMAs, balanced RSI")
print("")
