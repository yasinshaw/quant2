#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""V10 Iteration 13: Earlier exits + lower ADX"""
import requests
import time

API_URL = "http://localhost:8000/api/v1/backtest/run"

# Based on iteration 9, earlier exits and lower ADX
payload = {
    ...
    "parameters": {
        ...
        "rsi_long_exit": 62,            # Earlier exit (62 vs 64)
        "rsi_short_exit": 38,           # Earlier exit (38 vs 36)
        "atr_period": 14,
        "atr_stop_mult": 1.65,
        "atr_trailing_mult": 3.1,
        "risk_pct": 1.0,                # Keep 1.0%
        "max_leverage": 1.0,
        "use_adx_filter": True,
        "adx_period": 14,
        "adx_threshold": 21,            # Lower ADX (21 vs 22)
...
print("=" * 70)
print("V10 ITERATION #13: Earlier exits + lower ADX (based on iter9)")
print("=" * 70)
print("Changes from iteration 9:")
print("  - Earlier RSI exit: 62/38 vs 64/36")
