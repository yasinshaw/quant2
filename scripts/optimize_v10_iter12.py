#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""V10 Iteration 12: Minimal change from iteration 9"""
import requests
import time

API_URL = "http://localhost:8000/api/v1/backtest/run"

# Almost identical to iteration 9, only increase risk slightly
payload = {
    ...
    "parameters": {
        ...
        "risk_pct": 1.05,              # Only change: 1.05 vs 1.0
        "max_leverage": 1.0,
        "use_adx_filter": True,
        "adx_period": 14,
        "adx_threshold": 22,
...
print("=" * 70)
print("V10 ITERATION #12: Minimal change from iteration 9")
print("=" * 70)
print("Only change: risk_pct 1.05% vs 1.0% (to get more trades)")
print("")
